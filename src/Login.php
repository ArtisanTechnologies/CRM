...
<div class="lockscreen-wrapper" id="Lock">
    ...
    <form class="lockscreen-credentials" role="form" method="post" name="LoginForm" action="Login.php">
      <div class="input-group">
        <input type="hidden" id="UserBox2" name="User" class="form-control" value="<?= $urlUserName ?>">

        <input type="password" id="PasswordBox2" name="Password" class="form-control" placeholder="<?= gettext('Password')?>">
